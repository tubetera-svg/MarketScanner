import { Activity, Database, History, Rocket } from "lucide-react";
...
export default function Navigation({ active }: NavigationProps) {
  return (
    <>
      ...
      <a className={`top-link${active === "/backtest" ? " active" : ""}`} href="/backtest" aria-current={active === "/backtest" ? "page" : undefined}><History size={13} /> Backtest</a>
    </>
  );
}
